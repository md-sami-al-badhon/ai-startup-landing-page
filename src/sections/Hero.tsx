...
export const Hero = () => {
  ...
  return (
    <motion.section
      ...
      className="h-[492px] md:h-[800px] overflow-hidden flex  items-center  relative mask-[linear-gradient(to_bottom,transparent,black_10%,black_90%,transparent)] ">
      {/*  */}
      ...
      <motion.div
        ...
        className="absolute size-[344px] md:size-[580px] border rounded-full top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 border-white opacity-20 ">
        <div className="absolute size-2 rounded-full top-1/2 left-0 bg-white -translate-x-1/2 -translate-y-1/2 "></div>
        <div className="absolute size-2 rounded-full top-0 left-1/2 bg-white -translate-x-1/2 -translate-y-1/2 "></div>
      ...
      <motion.div
        animate={{ rotate: '-1turn' }}
        transition={{ duration: 60, repeat: Infinity, ease: 'linear' }}
        className="absolute size-[444px] md:size-[780px] rounded-full border border-white/20 top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 border-dashed"></motion.div>
      {/* bg-circle-line 3 */}
      <motion.div
        animate={{ rotate: '1turn' }}
        transition={{ duration: 60, repeat: Infinity, ease: 'linear' }}
        ...
        <div className="absolute size-2 rounded-full top-1/2 left-0 bg-white -translate-x-1/2 -translate-y-1/2 "></div>
        <div className="absolute size-2 rounded-full top-1/2 left-full bg-white -translate-x-1/2 -translate-y-1/2 "></div>
      </motion.div>
      {/* text */}
